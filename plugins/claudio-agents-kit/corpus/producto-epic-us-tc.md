# Criterios de corte entre Epic, User Story y Test Case

> Las plantillas viven en la plantilla de skill `epic-user-story-format`; aquí quedan los criterios.

---

## Origen: `product-analyst`
