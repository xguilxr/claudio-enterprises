---
name: redactar-adr
description: Registra una decisión técnica con su contexto, las opciones descartadas y sus consecuencias. Úsala cuando tomes una decisión difícil de revertir, o cuando excluyas un requisito del marco.
---

# Redactar adr

**Marco:** MCS
**Requisitos que ayuda a cumplir:** ARQ-02, GOB-02
...
El procedimiento vive en `marcos/mfb/MFB-T06-adr.md`, que **viaja con este plugin**. Un hecho reside en
un solo documento (TRZ-02); esta skill lo enruta, no lo copia.

1. Localizalo: `${CLAUDE_PLUGIN_ROOT}/marcos/mfb/MFB-T06-adr.md`. Si esa variable no resuelve, buscá
   `marcos/mfb/MFB-T06-adr.md` a partir del directorio de esta skill, subiendo hasta la raíz del plugin.
...
- `marcos/mfb/MFB-T06-adr.md` — procedimiento completo
