---
name: definir-indicador
description: Define una métrica con fórmula, grano, exclusiones, zona horaria y prueba de reconciliación. Úsala al crear un dashboard o un informe, o cuando dos números que deberían coincidir no coinciden.
---

# Definir indicador

**Marco:** MCS
**Requisitos que ayuda a cumplir:** DAT-10, DAT-13
...
El procedimiento vive en `marcos/mcs/MCS-CORE.md §5.7`, que **viaja con este plugin**. Un hecho reside en
...
- `marcos/mcs/MCS-CORE.md §5.7` — procedimiento completo
