---
name: rubrica-autonomia
description: Puntúa si algo es de verdad un agente o es un procedimiento bien escrito, con seis dimensiones y umbral declarado. Úsala antes de crear un agente nuevo o al revisar uno existente.
---

# Rubrica autonomia

**Marco:** MCS
**Requisitos que ayuda a cumplir:** IA-06
...
El procedimiento vive en `marcos/mcs/MCS-G04-disciplinas-transversales.md`, que **viaja con este plugin**. Un hecho reside en
un solo documento (TRZ-02); esta skill lo enruta, no lo copia.

1. Localizalo: `${CLAUDE_PLUGIN_ROOT}/marcos/mcs/MCS-G04-disciplinas-transversales.md`. Si esa variable no resuelve, buscá
   `marcos/mcs/MCS-G04-disciplinas-transversales.md` a partir del directorio de esta skill, subiendo hasta la raíz del plugin.
...
- `marcos/mcs/MCS-G04-disciplinas-transversales.md` — procedimiento completo
