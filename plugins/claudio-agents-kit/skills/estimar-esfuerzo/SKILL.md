...
description: Descompone un alcance y lo estima en rango, declarando los supuestos que lo sostienen. Úsala antes de dar una fecha o un precio.
---

# Estimar esfuerzo

**Marco:** MCC
**Requisitos que ayuda a cumplir:** ESF-01..07
**Confirmación humana requerida en:** Entregar la estimación al cliente
...
El procedimiento vive en `marcos/mcc/MCC-G03-economia-del-encargo.md`, que **viaja con este plugin**. Un hecho reside en
